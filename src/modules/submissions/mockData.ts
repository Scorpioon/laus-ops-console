...
export const mockSubmissions: MockSubmission[] = [
  {
    id: '1', code: '17/64795', title: 'Disseny exposiciÃ³', category: 'Branding',
    ...
    internalNotes: "Pendent d'aprovaciÃ³ final",
    projectUrl: 'https://projecte1.com', dropboxUrl: 'https://dropbox.com/1',
  },
  {
    id: '2', code: '18/02341', title: 'Campanya grÃ fica', category: 'Publicitat',
    ...
    internalNotes: 'RevisiÃ³ de proofs',
  ...
  {
    id: '7', code: '23/66789', title: 'IlÂ·lustraciÃ³ editorial', category: 'Editorial',
    payment: 'issue', material: 'ok',
    firstName: 'Laura', lastName: 'Estrany', email: 'laura@illustra.cat',
    studio: "IlÂ·lustra Laura", phone: '934567896', website: 'https://laura.cat',
    fadMember: false, associationMember: false, otherSubmissions: [],
    internalNotes: 'ReclamaciÃ³ pendent',
  ...
  },
  {
    ...
    fadMember: true, associationMember: true, otherSubmissions: [],
    internalNotes: 'LlicÃ¨ncia per revisar',
    projectUrl: 'https://font8.com', dropboxUrl: 'https://dropbox.com/8',
  },
  {
    id: '9', code: '25/88901', title: 'SenyalitzaciÃ³', category: 'Espai',
  ...
  {
    id: '10', code: '26/99012', title: 'AplicaciÃ³ mÃ²bil', category: 'Digital',
    payment: 'ok', material: 'ok',
  ...
  {
    id: '11', code: '27/10123', title: 'CatÃ leg exposiciÃ³', category: 'Editorial',
    payment: 'ok', material: 'ok',
    firstName: 'NÃºria', lastName: 'Valls', email: 'nuria@cataleg.cat',
    studio: 'CatÃ leg Valls', phone: '934567800', website: 'https://nuriavalls.cat',
    fadMember: true, associationMember: true, otherSubmissions: [],
  ...
  },
  {
    ...
    fadMember: false, associationMember: false, otherSubmissions: [],
    internalNotes: 'Esperant selecciÃ³',
    projectUrl: 'https://foto12.com', dropboxUrl: 'https://dropbox.com/12',
  },
  {
    id: '13', code: '29/32345', title: 'VÃ­deo corporatiu', category: 'Audiovisual',
    payment: 'ok', material: 'issue',
    firstName: 'SÃ­lvia', lastName: 'Grau', email: 'silvia@video.cat',
    studio: 'Video Grau', phone: '934567802', website: 'https://silviagrau.cat',
    fadMember: true, associationMember: true, otherSubmissions: [],
    internalNotes: 'Falta llicÃ¨ncia mÃºsica',
    projectUrl: 'https://video13.com', dropboxUrl: 'https://dropbox.com/13',
  },
  {
    id: '14', code: '30/43456', title: 'Eines de comunicaciÃ³', category: 'GrÃ fic',
    payment: 'ok', material: 'ok',
  ...
  {
    id: '15', code: '31/54567', title: "InstalÂ·laciÃ³ artÃ­stica", category: 'Espai',
    payment: 'issue', material: 'ok',
    firstName: 'MÃ²nica', lastName: 'Serra', email: 'monica@installacio.cat',
    studio: "InstalÂ·laciÃ³ Serra", phone: '934567804', website: 'https://monicaserra.cat',
    fadMember: false, associationMember: true, otherSubmissions: [],
    internalNotes: 'Esperant confirmaciÃ³',
  ...
  },
  {
    ...
    fadMember: true, associationMember: false, otherSubmissions: [],
    internalNotes: 'Prototip en revisiÃ³',
    projectUrl: 'https://producte16.com', dropboxUrl: 'https://dropbox.com/16',
  },
  {
    id: '17', code: '33/76789', title: "InterfÃ­cie d'usuari", category: 'Digital',
    payment: 'ok', material: 'ok',
  ...
  {
    id: '18', code: '34/87890', title: 'AnimaciÃ³ 2D', category: 'Audiovisual',
    payment: 'ok', material: 'issue',
    firstName: 'David', lastName: 'Parra', email: 'david@animacio.cat',
    studio: 'AnimaciÃ³ Parra', phone: '934567807', website: 'https://davidparra.cat',
    fadMember: false, associationMember: false, otherSubmissions: [],
  ...
  },
  {
    ...
    fadMember: true, associationMember: true, otherSubmissions: [],
    internalNotes: 'Pendent de distribuciÃ³',
    projectUrl: 'https://llibre19.com', dropboxUrl: 'https://dropbox.com/19',
  },
  {
    id: '20', code: '36/09012', title: "EstratÃ¨gia de marca", category: 'Branding',
    payment: 'ok', material: 'ok',
    firstName: 'Jordi', lastName: 'SolÃ ', email: 'jordi@marca.cat',
    studio: 'Marca SolÃ ', phone: '934567809', website: 'https://jordisola.cat',
    fadMember: true, associationMember: false, otherSubmissions: [],
